...
const ChatBot: React.FC<ChatBotProps> = ({ isOpen, setIsOpen }) => {
  ...
  return (
    <div className="fixed bottom-1 h-[92vh] md:h-screen right-0 z-50">
      {isOpen && (
        <div className="w-[80vw] h-[92vh] md:h-screen md:w-[36vw]" ref={chatbotRef}>
          <Card className="w-full h-full flex flex-col shadow-2xl">
            ...
            <div className="flex items-center gap-2 border-t p-1 bg-blue-300">
              <Input
                value={input}
